...
with Capstone_Project:
  ...
  st.write("🎯Our goal: predicting sale price of Real Estate in Ames, Iowa: <br>With this we aim to increase transparency in the complex real-estate market. <br>Real Estate Brokers are very expensive and with this tool customers can quickly and cheaply replace the cost-intense valuation", unsafe_allow_html = True)
